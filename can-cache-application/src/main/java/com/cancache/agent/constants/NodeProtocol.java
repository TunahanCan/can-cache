...
{
    // Internal CAS sentinel used to express an atomic create-if-absent operation.
    // Text-protocol CAS tokens generated by the server are always positive.
    long CAS_EXPECT_ABSENT = Long.MIN_VALUE;
