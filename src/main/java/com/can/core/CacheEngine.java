...
public final class CacheEngine<K,V> implements AutoCloseable
{
    ...
    public static final class Builder<K,V>
    {
        ...
        private MetricsRegistry metrics; private Broker broker; private Vertx vertx; private WorkerExecutor workerExecutor;
        ...
        public Builder<K,V> workerExecutor(WorkerExecutor workerExecutor){ this.workerExecutor=Objects.requireNonNull(workerExecutor); return this; }
